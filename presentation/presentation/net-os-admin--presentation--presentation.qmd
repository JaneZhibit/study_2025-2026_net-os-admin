...
## Объект и предмет исследования
 ...
 Предмет исследования:
   ...
   - Компоненты утилиты, принцип работы, структура, актуальность и значение.
  
## Цели и задачи

Основная цель:

 - Познакомиться с фильтром пакетов `iptables` как с инструментом обеспечения сетевой безопасности.
 
Задачи:

 - Рассмотреть компоненты, принцип работы и структуру утилиты iptables.
 - Оценить актуальность утилиты и её значение для сетевой безопасности.
...
iptables — это пользовательская утилита, позволяющая управлять правилами фильтрации пакетов и преобразования сетевых адресов.

- является интерфейсом к подсистеме Netfilter(встроенному механизму ядра Linux), который перехватывает и обрабатывает сетевые пакеты на различных этапах их прохождения через систему

-  основана на системе таблиц, цепочек правил и отдельных правил, которые определяют действия над пакетами данных
...
Пакеты проверяются на соответствие правилам в таблице и цепочках. При совпадении выполняется действие - принятие пакета, отбрасывание и др.
